...
<div class="hx-cover-title">
  ...
  <p>Замечаем риск по наблюдаемому признаку и выбираем действие до начала работы.</p>
</div>
...
<div class="hx-card"><div class="hx-number">2</div><h3>Кабели</h3><p>Остаются ли внутри рабочей зоны и закреплены ли?</p></div>
<div class="hx-card"><div class="hx-number">3</div><h3>Питание</h3><p>Нет ли видимого повреждения вилок, розеток и проводов?</p></div>
<div class="hx-card"><div class="hx-number">4</div><h3>Жидкости</h3><p>Удалены ли они от оборудования и соединений?</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Критерий должен быть видимым или проверяемым</div><div class="hx-slide-no">04</div></div>
...
<div class="hx-card"><div class="hx-number">2</div><p>Осмотреть маршрут движения и рабочую зону.</p></div>
<div class="hx-card"><div class="hx-number">3</div><p>Назвать конкретный наблюдаемый риск.</p></div>
<div class="hx-card"><div class="hx-number">4</div><p>Устранить условие или сообщить преподавателю.</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Не ищем «страшную картинку» — ищем проверяемый признак</div><div class="hx-slide-no">05</div></div>
...
<div class="hx-card"><h2>Нельзя доказать кадром</h2><p>Что человек обязательно споткнётся или что оборудование обязательно будет повреждено.</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Наблюдение ≠ гарантированный исход</div><div class="hx-slide-no">07</div></div>
...
<div class="hx-footer"><div class="hx-footer-line">Формат: вижу → риск → действие</div><div class="hx-slide-no">08</div></div>
...
<div class="hx-card"><h2>Объясните следствие</h2><p>Что меняется, когда кабель выходит в общий проход?</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Причина должна быть связана с тем, что видно</div><div class="hx-slide-no">09</div></div>
...
<div class="hx-card"><div class="hx-eyebrow hx-cyan">Сильнее</div><h2>«В проходе лежит кабель»</h2><p>Признак можно показать; действие — убрать кабель из маршрута движения.</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Другой человек должен суметь проверить ваш вывод</div><div class="hx-slide-no">10</div></div>
...
<div class="hx-card"><h2>Смотрите на рабочую зону</h2><p>Где питание? Где жидкости? Как расположены кабели и оборудование?</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Каждый называет один признак и объясняет «почему»</div><div class="hx-slide-no">11</div></div>
...
<div class="hx-footer"><div class="hx-footer-line">30 секунд на решение · затем короткая защита</div><div class="hx-slide-no">12</div></div>
...
<div class="hx-card"><div class="hx-number">2</div><h3>Место</h3><p>Где находится условие?</p></div>
<div class="hx-card"><div class="hx-number">3</div><h3>Риск</h3><p>Какое следствие связано с ним?</p></div>
<div class="hx-card"><div class="hx-number">4</div><h3>Действие</h3><p>Что изменить до начала работы?</p></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Не «плохо», а конкретно и проверяемо</div><div class="hx-slide-no">13</div></div>
...
<div class="hx-check"><div class="hx-number">2</div><div><h3>Кабели и питание</h3><p>Не пересекают маршрут; видимых повреждений нет.</p></div></div>
<div class="hx-check"><div class="hx-number">3</div><div><h3>Жидкости</h3><p>Не находятся рядом с оборудованием и соединениями.</p></div></div>
<div class="hx-check"><div class="hx-number">4</div><div><h3>Рабочая зона</h3><p>Можно начать работу, не перемещая опасно предметы вокруг себя.</p></div></div>
</div>

<div class="hx-footer"><div class="hx-footer-line">Сначала проверка — затем оборудование</div><div class="hx-slide-no">14</div></div>
...
<div class="hx-footer"><div class="hx-footer-line">Дальше: организация рабочего места и эргономика</div><div class="hx-slide-no">15</div></div>
